...
const classes: Record<Variante, string> = {
  ...
  perigo: 'w-full py-2 px-4 rounded-lg border border-red-800 text-red-400 hover:bg-red-900/30 transition-colors text-sm font-medium',
  atencao: 'w-full py-2 px-4 rounded-lg border border-orange-800 text-orange-500 hover:bg-orange-900/30 transition-colors text-sm font-medium',
